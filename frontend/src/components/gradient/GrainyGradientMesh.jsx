...
/**
 * GrainyGradientMesh - Three.js mesh with animated gradient shader
 * Simplified version without ripple effects for better performance
 */
export default function GrainyGradientMesh({
  onTimeUpdate,
  width = 200,
  height = 150
}) {
...
const fragmentShader = `
  ...
  vec3 multiColorGradient(float t) {
    vec3 colors[7];
    colors[0] = hexToRgb(250.0, 212.0, 251.0); // light purple/pink
    colors[1] = hexToRgb(250.0, 200.0, 225.0); // pink
    colors[2] = hexToRgb(250.0, 182.0, 21.0);  // yellow/gold
    colors[3] = hexToRgb(252.0, 104.0, 30.0);  // orange
    colors[4] = hexToRgb(13.0, 93.0, 244.0);   // blue
    colors[5] = hexToRgb(11.0, 74.0, 187.0);   // darker blue
    colors[6] = hexToRgb(23.0, 14.0, 7.0);     // very dark brown/black
